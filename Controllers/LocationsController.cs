...
namespace AfterSchool.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(AfterSchoolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Locations != null ? 
                          ...
                          Problem("Entity set 'AfterSchoolContext.Locations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AfterSchoolContext.Locations'  is null.");
            }
            var location = await _context.Locations.FindAsync(id);
            if (location != null)
            {
